...
<nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent mt-4">
    <div class="container">
        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="<?= base_url('Home'); ?>">
            S I M A K
        </a>
        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav mx-auto ms-xl-auto me-xl-7">
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center me-2" aria-current="page" href="<?= base_url('Home'); ?>">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        ...
                        <!-- <p class="text-lead text-white">Kurikulum Berbasis Kompetensi (KBK) adalah suatu pendekatan dalam perancangan kurikulum yang menekankan pengembangan kompetensi atau keterampilan peserta didik sebagai tujuan utama.</p> -->
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <?= $this->session->flashdata('message'); ?>
                            <form role="form text-left" method="POST" action="<?= base_url('Auth/cek_registrasi'); ?>">
                                <div class="mb-3">
                                    <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama lengkap" aria-label="Name" aria-describedby="email-addon">
                                </div>
                                <div class="mb-3">
                                    <input type="email" id="email" name="email" class="form-control" placeholder="Email" aria-label="Alamat email" aria-describedby="email-addon">
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" id="password1" name="password1" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="password-addon">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password" id="password2" name="password2" class="form-control" placeholder="Ulangi password" aria-label="Password" aria-describedby="password-addon">
                                    </div>
                                    ...
                                    <p class="text-sm mt-3 mb-0">Sudah memiliki akun?
                                        <a href="<?= base_url('Auth'); ?>" class="text-dark font-weight-bolder text-gradient">Sign in</a>
                                    </p>
                            </form>
                        </div>
                    </div>
