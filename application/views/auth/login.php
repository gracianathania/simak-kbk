                    ...
                    <div class="row">
                            ...
                            <div class="card card-plain mt-8">
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-4 text-sm mx-auto">
                                        Belum memiliki akun?
                                        <a href="<?= base_url('Auth/registrasi'); ?>" class="text-info text-gradient font-weight-bold">Sign
                                            up</a>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('<?= base_url('assets/') ?>img/curved-images/curved6.jpg')">
                                </div>
                            </div>
                        </div>
                    </div>
